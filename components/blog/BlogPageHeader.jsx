...
const BlogPageHeader = () => {
    const primaryBg = useColorModeValue("backgrounds.light.100", "backgrounds.dark.100");
    const secondaryBg = useColorModeValue("backgrounds.light.200", "backgrounds.dark.200");
    return (
        <>
            <NavContainer secondaryBgColor={secondaryBg} primaryBgColor={primaryBg}>
            ...
            <Container maxW={"3xl"} mt={"80px"}>
                ...
                >
                    ...
                    <Text color={"gray.500"}>
                        The new dawn balloons as we free it. For there is always light, if only
